...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_assignments = 8,                /* assignments  */
...
static const char *const yytname[] =
{
  ...
  "'='", "';'", "$accept", "assignments", "assignment", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* assignment: STRING '=' NUMBER ';'  */
#line 23 "reflexexample3.y"
